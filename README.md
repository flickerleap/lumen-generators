...
- **Comming versions**
    ...
    - Requested Feature: [Add possibility to not run migrations when using `flickerleap:resources`](https://github.com/webNeat/lumen-generators/issues/23)
...
- **Version 1.3.1**
    ...
    - Bug Fixed:  [duplicate column for the foriegn key when using `flickerleap:resources`](https://github.com/webNeat/lumen-generators/issues/22)
...
- **Version 1.2.0**
    ...
    - Feature added: [Specifying namespace for `flickerleap:resource` and `flickerleap:resources`](https://github.com/webNeat/lumen-generators/issues/18)

- **Version 1.1.1**

    - Pivot table generation from the `flickerleap:resources` command bug fixed.
