...
$I->runShellCommand('php artisan flickerleap:factory "App\Task"');
...
$I->runShellCommand('php artisan flickerleap:factory "App\Task" --fields="title:sentence(3),description:paragraph(3),due:date,hidden:boolean"');
$I->seeInShellOutput('App\Task factory generated');
$I->openFile('./database/factories/ModelFactory.php');
$I->seeInThisFile(
