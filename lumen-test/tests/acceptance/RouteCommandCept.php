...
$I->runShellCommand('php artisan flickerleap:route project-type');
...
$I->runShellCommand('php artisan flickerleap:route foo --controller=customController');
...
$I->wantTo('run flickerleap:routes in Lumen 5.3+');
